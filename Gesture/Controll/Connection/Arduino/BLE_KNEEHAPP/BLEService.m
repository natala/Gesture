...
{ @"F9266FD7-EF07-45D6-8EB6-BD74F13620F9",
  @"ffe0",
  @"713D0000-503E-4C75-BA94-3148F18D941E" };         // Dr. Kroll Shield, Jennic Module, RedBearLab Shield
...
NSString *const kBleCharacteristics[kBleNumSupportedServices][2] = {
    ...
    {@"B42E7612-4F85-E854-1284-D059B16DF131", @"B42E7612-4F85-E854-1284-D059B16DF131"}
};                                                   // RX; TX
...
- (void)start
{
	...
	[self.peripheral discoverServices:[BLEDiscovery sharedInstance].supportedServiceUUIDs];
}
